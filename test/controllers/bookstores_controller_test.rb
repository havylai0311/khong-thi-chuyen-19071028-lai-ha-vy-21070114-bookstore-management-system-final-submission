...
class BookstoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookstore" do
    assert_difference("Bookstore.count") do
      post bookstores_url, params: { bookstore: { email_address: @bookstore.email_address, name: @bookstore.name } }
    end
  ...
  test "should update bookstore" do
    patch bookstore_url(@bookstore), params: { bookstore: { email_address: @bookstore.email_address, name: @bookstore.name } }
